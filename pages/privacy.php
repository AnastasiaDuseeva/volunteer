<?php
// privacy.php — Политика обработки персональных данных

// Инициализируем переменную, чтобы убрать Warning
...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/style_policy.css"> <!-- новый файл со стилями для политики -->
